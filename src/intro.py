...
class Intro():
    ...
    def show(self, display: pygame.surface.Surface):
        ...
        display.blit(CLICK_PROMPT, (get_window_size()[0] - CLICK_PROMPT.get_width() - 20, 20))


        # draw text
        textRect = pygame.rect.Rect(20, 812.28 * DISPLAY_SCALING + 20, (1558 * DISPLAY_SCALING) - 20, (149 * DISPLAY_SCALING) - 20)
        drawText(display, self.intro_lines[self.current_page], (255, 255, 255), textRect, pygame.font.Font(config.FONT[0], config.FONT[1]))
